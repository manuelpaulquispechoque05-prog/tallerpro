        ...
        <table class="w-full text-sm">
            ...
            <tbody>
                ...
                <tr class="border-b border-white/[0.03] hover:bg-white/[0.02]">
                    <td class="px-5 py-4 text-sm text-gray-200">{{ $i->nombre }}</td>
                    <td class="px-5 py-4 text-right">
                        ...
                        <form method="POST" action="{{ route('panel.especialidades.destroy', $i->id) }}" onsubmit="return confirm('Eliminar?')" class="inline">@csrf @method('DELETE')<button type="submit" class="p-2 rounded-lg hover:bg-white/10 transition text-gray-400 hover:text-red-400"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg></button></form>
                    </td>
                </tr>
                @empty

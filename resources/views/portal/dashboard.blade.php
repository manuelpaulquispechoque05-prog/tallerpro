    ...
    <div class="glass-card rounded-2xl p-5 hover:shadow-lg transition-all duration-300">
        <div class="flex items-center gap-3 mb-3">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500">{{ $cliente?->vehiculos?->count() ?? 0 }} registrados</p>
            </div>
        </div>
        <a href="{{ route('portal.vehiculos.index') }}" class="inline-flex items-center text-sm font-medium text-blue-400 hover:text-blue-300 transition gap-1">
    ...
    <div class="glass-card rounded-2xl p-5 hover:shadow-lg transition-all duration-300">
        <div class="flex items-center gap-3 mb-3">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500">Agenda una cita en la sucursal de tu preferencia</p>
            </div>
        </div>
        <a href="{{ route('portal.citas.create') }}" class="inline-flex items-center text-sm font-medium text-blue-400 hover:text-blue-300 transition gap-1">
            Reservar cita <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"/></svg>
        </a>
    </div>
</div>

...
<nav x-data="{ open: false, scrolled: false }" 
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
            ...
            <div class="hidden md:flex items-center gap-4">
                @if (Route::has('login'))
                    @auth
                        <a href="{{ route('panel.dashboard') }}" class="inline-flex items-center text-sm font-medium text-gray-300 hover:text-white transition gap-1.5">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="text-sm font-medium text-gray-300 hover:text-white transition">Iniciar sesion</a>
                    @endauth
                @endif
    ...
    <div x-show="open" @click.away="open = false" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 -translate-y-4" x-transition:enter-end="opacity-100 translate-y-0" class="md:hidden bg-[#0a0a0a]/95 backdrop-blur-xl border-t border-white/10">
        <div class="px-6 py-6 space-y-4">
            ...
            @if (Route::has('login'))
                @auth
                    <a href="{{ route('panel.dashboard') }}" class="block text-blue-400 font-medium">Dashboard</a>
                @else
                    <a href="{{ route('login') }}" class="block text-gray-300">Iniciar sesion</a>
                @endauth
            @endif
...
<section id="inicio" class="relative h-screen overflow-hidden bg-black">
    <div x-data="{ 
        slides: [
            { img: '{{ asset('images/hero/car.png') }}', tag: 'Servicio profesional',       title: 'El mejor cuidado para tu vehiculo',           desc: 'Diagnostico computarizado, mecanicos certificados y repuestos originales.',  cta: 'Reservar cita' },
            { img: '{{ asset('images/hero/car2.png') }}', tag: 'Diagnostico de precision',   title: 'Tu vehiculo merece atencion de expertos',    desc: 'Agenda un diagnostico completo y recibe un presupuesto sin compromiso.',       cta: 'Agendar diagnostico' },
            { img: '{{ asset('images/hero/moto.png') }}', tag: 'Taller multiplataforma',      title: 'Servicio para autos y motos',                desc: 'Cubrimos todo tipo de vehiculos con el mismo nivel de calidad y garantia.',   cta: 'Ver servicios' },
            { img: '{{ asset('images/hero/moto2.png') }}',tag: 'Mantenimiento preventivo',    title: 'Preven antes que reparar',                   desc: 'Mantenimiento periodico para alargar la vida util de tu vehiculo.',           cta: 'Agendar mantenimiento' },
            { img: '{{ asset('images/hero/moto3.png') }}',tag: 'Repuestos originales',        title: 'Calidad que se siente',                      desc: 'Solo trabajamos con repuestos originales y de las mejores marcas del mercado.',cta: 'Ver repuestos' }
        ],
    ...
    <div x-data="{ visible: false }" x-intersect:enter="visible = true" class="max-w-7xl mx-auto px-6 lg:px-8 relative">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8" :class="visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'" style="transition: all 0.8s ease-out 0.3s">
            ...
            <div class="service-card group relative rounded-2xl overflow-hidden cursor-pointer aspect-[4/3] lg:aspect-[3/4]">
                <img src="{{ asset('images/services/aceite/aceitecar.jpg') }}" alt="Cambio de aceite" class="service-img absolute inset-0 w-full h-full object-cover">
            ...
            <!-- 2. Frenos -->
            <div class="service-card group relative rounded-2xl overflow-hidden cursor-pointer aspect-[4/3] lg:aspect-[3/4]">
                <img src="{{ asset('images/services/frenos/frenoscar.jpg') }}" alt="Frenos" class="service-img absolute inset-0 w-full h-full object-cover">
                <div class="service-overlay absolute inset-0 bg-gradient-to-t from-black/90 via-black/30 to-transparent opacity-90 transition-all duration-500"></div>
                <div class="relative h-full flex flex-col justify-end p-6 lg:p-8">
                    <div class="service-glass bg-white/[0.06] backdrop-blur-xl border border-white/10 rounded-xl p-5">
            ...
            <div class="service-card group relative rounded-2xl overflow-hidden cursor-pointer aspect-[4/3] lg:aspect-[3/4]">
                <img src="{{ asset('images/services/alineacion/alineacioncar.jpg') }}" alt="Alineacion" class="service-img absolute inset-0 w-full h-full object-cover">
                <div class="service-overlay absolute inset-0 bg-gradient-to-t from-black/90 via-black/30 to-transparent opacity-90 transition-all duration-500"></div>
                <div class="relative h-full flex flex-col justify-end p-6 lg:p-8">
                    <div class="service-glass bg-white/[0.06] backdrop-blur-xl border border-white/10 rounded-xl p-5">
            ...
            <!-- 4. Diagnostico -->
            <div class="service-card group relative rounded-2xl overflow-hidden cursor-pointer aspect-[4/3] lg:aspect-[3/4]">
                <img src="{{ asset('images/services/diagnostico/diagnosticocar.jpg') }}" alt="Diagnostico" class="service-img absolute inset-0 w-full h-full object-cover">
                <div class="service-overlay absolute inset-0 bg-gradient-to-t from-black/90 via-black/30 to-transparent opacity-90 transition-all duration-500"></div>
                <div class="relative h-full flex flex-col justify-end p-6 lg:p-8">
                    <div class="service-glass bg-white/[0.06] backdrop-blur-xl border border-white/10 rounded-xl p-5">
            ...
            <!-- 5. Suspension -->
            <div class="service-card group relative rounded-2xl overflow-hidden cursor-pointer aspect-[4/3] lg:aspect-[3/4]">
                <img src="{{ asset('images/services/suspencion/suspencioncar.jpg') }}" alt="Suspension" class="service-img absolute inset-0 w-full h-full object-cover">
                <div class="service-overlay absolute inset-0 bg-gradient-to-t from-black/90 via-black/30 to-transparent opacity-90 transition-all duration-500"></div>
                <div class="relative h-full flex flex-col justify-end p-6 lg:p-8">
                    <div class="service-glass bg-white/[0.06] backdrop-blur-xl border border-white/10 rounded-xl p-5">
            ...
            <div class="service-card group relative rounded-2xl overflow-hidden cursor-pointer aspect-[4/3] lg:aspect-[3/4]">
                <img src="{{ asset('images/services/bateria-electrical/bateriacar.jpg') }}" alt="Bateria" class="service-img absolute inset-0 w-full h-full object-cover">
                <div class="service-overlay absolute inset-0 bg-gradient-to-t from-black/90 via-black/30 to-transparent opacity-90 transition-all duration-500"></div>
                <div class="relative h-full flex flex-col justify-end p-6 lg:p-8">
                    <div class="service-glass bg-white/[0.06] backdrop-blur-xl border border-white/10 rounded-xl p-5">
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="relative" :class="visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'" style="transition: all 1s ease-out 0.3s">
                <div class="aspect-[4/5] rounded-2xl overflow-hidden relative">
                    ...
                    <img src="{{ asset('images/hero/car3.png') }}" alt="Taller" class="w-full h-full object-cover">
...
<footer id="contacto" class="bg-[#070707] border-t border-white/5">
    <div class="max-w-7xl mx-auto px-6 lg:px-8 py-16 lg:py-20">
        ...
        <div class="mt-16 pt-8 border-t border-white/5 text-center text-sm text-gray-600"><p>&copy; {{ date('Y') }} Taller Pro. Todos los derechos reservados.</p></div>
    </div>
</footer>

...
<body class="font-sans antialiased bg-[#0a0a0a] min-h-screen flex">
    ...
    <div class="hidden lg:block relative w-1/2 overflow-hidden">
        <div class="absolute inset-0 bg-cover bg-center" style="background-image: url('<?php echo e(asset('images/hero/car2.png')); ?>')"></div>
...
<?php /**PATH C:\laragon\www\TallerPro\resources\views/layouts/guest.blade.php ENDPATH**/ ?>
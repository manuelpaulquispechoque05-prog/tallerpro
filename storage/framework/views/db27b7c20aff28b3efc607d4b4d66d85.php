...
<div class="glass-card rounded-2xl overflow-hidden">
    <div class="px-5 lg:px-6 py-4 border-b border-white/[0.06] flex items-center justify-between">
        ...
        <a href="<?php echo e(route('panel.categorias.create')); ?>" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-600 to-blue-500 text-white text-xs font-semibold rounded-full transition shadow-lg shadow-blue-500/25">Nueva categoria</a>
    </div>
    <div class="px-5 lg:px-6 py-3 border-b border-white/[0.06]">
        <form method="GET" x-data>
            <div class="relative max-w-md">
                ...
                <input type="text" name="busqueda" value="<?php echo e(request('busqueda')); ?>" placeholder="Buscar categoria..." class="w-full pl-10 pr-4 py-2 bg-white/5 border border-white/10 rounded-xl text-sm text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50" x-on:input.debounce.500ms="$el.form.submit()">
            </div>
        </form>
    </div>
        ...
        <table class="w-full text-sm">
            ...
            <tbody>
                ...
                <tr class="border-b border-white/[0.03] hover:bg-white/[0.02] transition-colors">
                    ...
                    <td class="px-5 py-4 text-sm text-gray-500"><?php echo e($i->descripcion ?? '—'); ?></td>
                    <td class="px-5 py-4 text-right">
                        <a href="<?php echo e(route('panel.categorias.edit', $i->id)); ?>" class="p-2 rounded-lg hover:bg-white/10 transition text-gray-400 hover:text-yellow-400 inline-block">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                        </a>
                        <form method="POST" action="<?php echo e(route('panel.categorias.destroy', $i->id)); ?>" onsubmit="return confirm('Eliminar categoria?')" class="inline">
...
<?php echo $__env->make('layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\TallerPro\resources\views/panel/categorias/index.blade.php ENDPATH**/ ?>
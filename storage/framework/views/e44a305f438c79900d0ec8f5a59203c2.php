...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Mi cuenta'); ?> — <?php echo e(config('app.name', 'Taller Pro')); ?></title>
    ...
    <nav x-data="{ open: false }" class="sticky top-0 z-30 border-b border-white/[0.06] bg-[#0a0a0a]/80 backdrop-blur-xl">
        <div class="max-w-6xl mx-auto px-4 sm:px-6">
            <div class="flex items-center justify-between h-16">
                <!-- Logo -->
                <a href="<?php echo e(route('portal.inicio')); ?>" class="flex items-center gap-2 shrink-0">
                ...
                <div class="hidden md:flex items-center gap-5">
                    <a href="<?php echo e(route('portal.inicio')); ?>" class="text-sm text-gray-400 hover:text-white transition">Inicio</a>
                    <a href="<?php echo e(route('portal.vehiculos.index')); ?>" class="text-sm text-gray-400 hover:text-white transition">Mis vehiculos</a>
                    ...
                    <a href="<?php echo e(route('portal.perfil')); ?>" class="text-sm text-gray-400 hover:text-white transition">Mi perfil</a>
        ...
        <div x-show="open" @click.away="open = false" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 -translate-y-2" x-transition:enter-end="opacity-100 translate-y-0" class="md:hidden border-t border-white/[0.06] bg-[#0a0a0a]">
            <div class="px-4 py-4 space-y-3">
                <a href="<?php echo e(route('portal.inicio')); ?>" @click="open = false" class="block text-sm text-gray-300 hover:text-white">Inicio</a>
                <a href="<?php echo e(route('portal.vehiculos.index')); ?>" @click="open = false" class="block text-sm text-gray-300 hover:text-white">Mis vehiculos</a>
                ...
                <a href="<?php echo e(route('portal.perfil')); ?>" @click="open = false" class="block text-sm text-gray-300 hover:text-white">Mi perfil</a>
...
<?php /**PATH C:\laragon\www\TallerPro\resources\views/layouts/portal.blade.php ENDPATH**/ ?>